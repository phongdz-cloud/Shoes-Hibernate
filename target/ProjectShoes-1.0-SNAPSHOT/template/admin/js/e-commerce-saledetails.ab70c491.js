...
document.addEventListener("DOMContentLoaded", function() {
    const dataTable = new simpleDatatables.DataTable("#saledetailsDatatable", {
        columns: [
    ...
    dataTable.on("datatable.init", function(args) {
        document.getElementById("saledetailsDatatable").closest(".preload-wrapper").classList.add("opacity-10");
    });
});