...
document.addEventListener("DOMContentLoaded", function() {
    const dataTable = new simpleDatatables.DataTable("#deliveryDatatable", {
        columns: [
    ...
    dataTable.on("datatable.init", function(args) {
        document.getElementById("deliveryDatatable").closest(".preload-wrapper").classList.add("opacity-10");
    });
});