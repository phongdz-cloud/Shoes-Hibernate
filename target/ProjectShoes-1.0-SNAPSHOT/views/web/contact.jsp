        ...
        <div class="page-banner-in">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-12">
                    <h1 class="page-banner-title text-uppercase">HỆ THỐNG CỬA HÀNG</h1>
                </div>
                <div class="col-xl-6 col-lg-6 col-12">
                    <ul class="right-side">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="aa-contact-area">
                    <div class="aa-contact-top" style="height: 30px">
                            ...
                            <div class="col-md-5">
                                <div class="aa-contact-address-right">
                                    <address>
                                        ...
                                        <p><span class="fa fa-envelope"></span>Email: xpoge@gmail.com</p>
                                    </address>
                                </div>
                            </div>
                        </div>
