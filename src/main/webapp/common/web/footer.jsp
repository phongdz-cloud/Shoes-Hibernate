        ...
        <div class="footer-inner">
            <div class="footer-box">
                <div class="footer-logo">
                    <a href="<c:url value="/trang-chu"/>"><img
                            src="<c:url value='/template/web/images/logo1.png'/> "
                            alt="logo"></a>
                </div>
                <p class="footer-desc">Lorem ipsum dolor sit amet, consectetur adipi-scing elit. In
                    purus sem, consectetur sed aliquam vel, hendrerit in elit. Nunc interdum dolor
                    at quam pulvinar sodales. Nunc venenatis egestas mi ac fermentum.</p>
            </div>
            <div class="footer-box footer-static">
                ...
                <ul class="footer-block-contant">
                    ...
                    <li><a href="<c:url value="/error-page"/>">Wish List</a></li>
            ...
            <div class="footer-box footer-static">
                ...
                <ul class="footer-block-contant">
                    <li><a href="<c:url value="/error-page"/>">About Us</a></li>
                    <li><a href="#">Delivery Information</a></li>
                    <li><a href="#">Privacy Policy</a></li>
                    <li><a href="#">Terms & Conditions</a></li>
                    <li><a href="<c:url value="/error-page"/>">Contact Us</a></li>
            ...
            <div class="footer-box footer-contact footer-static m-0">
                ...
                <ul class="footer-block-contant">
                    <li><img src="<c:url value='/template/web/images/cont-1.png'/>"
                             alt="img"><span>28 Green Tower, Street Name <br>New York City, USA</span>
                    </li>
                    <li><img src="<c:url value='/template/web/images/cont-2.png'/>" alt="img"><a
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <p class="copyright-text">&#169; Xpoge all Rights Reserverd theme by <a
                            href="https://templatescoder.com/" target="_blank">TemplatesCoder</a>
                    </p>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <ul>
